...
import { COMBATANT_SIDE, ELEMENTAL_RESISTANCES, ELEMENTS, RANGE, STATS, STATUS, WEAPON_ELEMENTS } from '../Constants.js';
...
export default class Character extends Combatant {
  ...
  resolveAction({ party, enemies, rng, tick, turn_count }) {
    this.setActed(true);
    switch(this.action.type) {
      case ACTION_TYPES.ATTACK: {
        ...
        const wait = targetEnemy.isBusy(tick);
