...
const rng = new RNG(0xa5e9ad85);

const greatForestBattles = Areas['Great Forest'].generateEncounters(rng, 20000, 0, true);
...
const dwarvesTrailBattles = Areas['Dwarves Trail'].generateEncounters(new RNG(rng.originalRNG), 20000, 0, true);
