export const enemies = {
  ...
  "Gregminster Palace": {
    ...
    "encounters": [
      ...
      { "name": "3 Imperial Guards",
        "parseString": "3 ImperialGuards(sabre)" },
      ...
      { "name": "3 ImperialGuards 1 Colossus",
        "parseString": "2 ImperialGuards(sabre) 1 ImperialGuards(sword) 1 Colossus" }],
    "enemies": {
      "Colossus": {
        "bits": 15000,
        "drops": [
  ...
  "Lepants Mansion": {
    ...
    "encounters": [
      ...
      { "name": "3 Robot Soldiers",
        "parseString": "1 RobotSoldier(spear) 2 RobotSoldier(sword)" },
      { "name": "6 Robot Soldiers",
        "parseString": "3 RobotSoldier(sword) 3 RobotSoldier(spear)" }],
    "enemies": {
      "RobotSoldier(sword)": {
        "bits": 400,
        "drops": [
  ...
  "Magicians Island": {
    ...
    "encounters": [
      ...
      { "name": "3 Holly Boy 2 FurFur",
        "parseString": "3 HollyBoy 2 FurFur" },
      { "name": "2 FurFur",
        "parseString": "2 FurFur" },
      { "name": "4 Holly Boy",
        "parseString": "4 HollyBoy" },
      { "name": "6 Holly Boy",
        "parseString": "6 HollyBoy" },
  ...
  "Bosses": {
    ...
    "encounters": [
      { "name": "Golem",
        "parseString": "1 Golem" },
      { "name": "Varkas & Sydonia",
        "parseString": "1 Varkas 1 Sydonia" },
      { "name": "Zombie Dragon",
  ...
  "Other Enemies": {
    ...
    "encounterRate": 0,
    "encounters": [
      { "name": "Seifu 5 Bandits",
        "parseString": "2 Bandit(green) 2 Bandit(red) 1 Bandit(yellow)" },
      { "name": "Grady 2 Soldier",
        "parseString": "2 EmpireSoldierSword" },
      { "name": "Grady 6 Soldier",
        "parseString": "3 EmpireSoldierSpear 2 EmpireSoldierBow 1 EmpireCaptain" },
      { "name": "Lenankamp 5 Soldier",
        "parseString": "5 EmpireSoldierL" },
      { "name": "Seika 3 Soldiers",
        "parseString": "2 EmpireSoldier(sword) 1 EmpireSoldier(spear)" },
      { "name": "Kraze 6 Soldier",
        "parseString": "6 EmpireSoldier" },
      { "name": "Kobold Village 6 Soldier",
        "parseString": "6 VeteranSoldier(spear)" },
      { "name": "3 Sonierre VeteranSoldier #1",
        "parseString": "3 VeteranSoldier(spear)" },
      { "name": "3 Sonierre VeteranSoldier #2",
        "parseString": "1 VeteranSoldier(bow) 2 VeteranSoldier(spear)" },
      { "name": "5 Sonierre VeteranSoldier #1",
        "parseString": "3 VeteranSoldier(spear) 2 VeteranSoldier(bow)" },
      { "name": "5 Sonierre VeteranSoldier #2",
        "parseString": "1 VeteranSoldier(bow) 3 VeteranSoldier(spear) 1 VeteranSoldier(bow)"
      },
      { "name": "Gregminster 4 Imperial Guards",
        "parseString": "3 ImperialGuards(sword) 1 ImperialGuards(sabre)" },
      { "name": "Gregminster 5 Imperial Guards",
        "parseString": "2 ImperialGuards(sword) 3 ImperialGuards(sabre)" },
    ],
    "enemies": {
      "Bandit(green)": {
        "bits": 70,
