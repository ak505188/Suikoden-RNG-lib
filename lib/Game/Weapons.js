import { WEAPON_ELEMENTS} from './Constants.js';
...
export const WEAPONS = [
  ...
  { NAMES: ['Galm', 'Fenril', 'Loki'], TYPE: WEAPON_TYPES.SPEAR, ELEMENT: WEAPON_ELEMENTS.NONE },
  { NAMES: ['Slavenil', 'Gunnigle', 'Odin'], TYPE: WEAPON_TYPES.SPEAR, ELEMENT: WEAPON_ELEMENTS.NONE },
  {
  ...
  { NAMES: ['Axe', 'Battle Axe', 'Ogre Axe'], TYPE: WEAPON_TYPES.AXE, ELEMENT: WEAPON_ELEMENTS.NONE },
  { NAMES: ['Satsuki', 'Akemi', 'Mizuki'], TYPE: WEAPON_TYPES.SPEAR, ELEMENT: WEAPON_ELEMENTS.NONE },
  {
    NAMES: ['Uranami Spear', 'Seigetsu Spear', 'Matsukaze Spear'],
    TYPE: WEAPON_TYPES.SPEAR,
    ELEMENT: WEAPON_ELEMENTS.NONE,
  },
  { NAMES: ['Wind Rod', 'Gale Rod', 'Gust Rod'], TYPE: WEAPON_TYPES.ROD, ELEMENT: WEAPON_ELEMENTS.NONE },
  {
  ...
  { NAMES: ['Gear', 'Iron Gear', 'Metal Gear'], TYPE: WEAPON_TYPES.DARTS, ELEMENT: WEAPON_ELEMENTS.WIND },
  {
    NAMES: ['Light Bow', 'Shine Bow', 'Elfin Bow'],
    TYPE: WEAPON_TYPES.BOW,
    ELEMENT: WEAPON_ELEMENTS.WIND,
  },
  { NAMES: ['Stick', 'Oak Stick', 'Ebony Stick'], TYPE: WEAPON_TYPES.ROD, ELEMENT: WEAPON_ELEMENTS.NONE },
  {
  ...
  { NAMES: ['Verserk', 'Sigmund', 'Sigurd'], TYPE: WEAPON_TYPES.SPEAR, ELEMENT: WEAPON_ELEMENTS.NONE },
  {
  ...
  },
  {
    ...
    TYPE: WEAPON_TYPES.ONE_HANDED_SWORD,
    ELEMENT: WEAPON_ELEMENTS.WATER,
  },
  { NAMES: ['Night Bow', 'Moon Bow', 'Elfin Bow'], TYPE: WEAPON_TYPES.BOW, ELEMENT: WEAPON_ELEMENTS.WIND },
  {
  ...
  },
  {
    ...
    TYPE: WEAPON_TYPES.ONE_HANDED_SWORD,
    ELEMENT: WEAPON_ELEMENTS.LIGHTNING,
  },
  {
  ...
  { NAMES: ['Silver Rod', 'Moon Rod', 'Star Rod'], TYPE: WEAPON_TYPES.ROD, ELEMENT: WEAPON_ELEMENTS.NONE },
  {
  ...
  { NAMES: ['Wolf', 'Tiger', 'Dragon'], TYPE: WEAPON_TYPES.CLAWS, ELEMENT: WEAPON_ELEMENTS.NONE },
  {
  ...
  { NAMES: ['Rod', 'Earth Rod', 'Gaia Rod'], TYPE: WEAPON_TYPES.ROD, ELEMENT: WEAPON_ELEMENTS.NONE },
  {
    NAMES: ['Milk Pan', 'Frying Pan', 'Ceramic Pan'],
    TYPE: WEAPON_TYPES.AXE,
    ELEMENT: WEAPON_ELEMENTS.NONE,
  },
  { NAMES: ['Pan', 'Pot', 'Wok'], TYPE: WEAPON_TYPES.AXE, ELEMENT: WEAPON_ELEMENTS.NONE },
  {
  ...
  { NAMES: ['Wind', 'Storm', 'Tornado'], TYPE: WEAPON_TYPES.DARTS, ELEMENT: WEAPON_ELEMENTS.NONE },
  {
...
export class Weapon {
  // Frames of the target's reaction when a Fire or Lightning rune piece is attached
  static RUNE_PIECE_REACTION = 34;
  ...
  constructor(weapon, lvl = 1) {
    this.wpn = weapon;
    this.lvl = lvl;
    this.baseElement = weapon.ELEMENT || WEAPON_ELEMENTS.NONE;
    /** @type {{ element: WeaponElement, amount: number }} */
    this.runePiece = {
      element: WEAPON_ELEMENTS.NONE,
      amount: 0
    }
  ...
  /** @param {WeaponElement} element */
  setRunePiece(element, amount = 1) {
    if (element === WEAPON_ELEMENTS.NONE) amount = 0;
    this.runePiece = {
      element,
      amount
    }
  ...
  /**
   * Rune Piece damage amp (calc_damage): base += (base / 20) * pieces, Fire or Earth pieces only.
   * @param {number} base
   */
  applyRunePieceAmp(base) {
    if (this.runePiece.element !== WEAPON_ELEMENTS.FIRE && this.runePiece.element !== WEAPON_ELEMENTS.EARTH)
      return base;
    return base + cDiv(base, 20) * this.runePiece.amount;
  }

  /** @returns {number|null} Reaction frames overriding the character's hit/crit reaction, if any. */
  get runePieceReaction() {
    if (this.runePiece.element !== WEAPON_ELEMENTS.FIRE && this.runePiece.element !== WEAPON_ELEMENTS.LIGHTNING)
      return null;
    return Weapon.RUNE_PIECE_REACTION;
  }

  get element() {
    return this.runePiece.element !== WEAPON_ELEMENTS.NONE ? this.runePiece.element : this.baseElement;
  }
