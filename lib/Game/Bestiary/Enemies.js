...
/**
 * @typedef {'Weak'|'Strong'|'Invulnerable'} ElementalResistance
 */
...
export const ENEMIES = {
  ...
  BANSHEE: {
    ...
    elements: { Fire: 'Strong', Lightning: 'Strong', Wind: 'Weak' },
  },
  CLAY_DOLL: {
    name: 'Clay Doll',
    LVL: 44,
    ...
    elements: { Lightning: 'Weak', Wind: 'Strong' },
  },
  RED_ELEMENTAL: {
    name: 'Red Elemental',
    LVL: 42,
  ...
  IVY: {
    ...
    elements: { Fire: 'Weak', Lightning: 'Weak' },
  },
  MIRAGE: {
    name: 'Mirage',
    LVL: 52,
  ...
  SHADOW_MAN: {
    ...
    elements: { Lightning: 'Weak', Earth: 'Weak' },
  },
  ...
  MAGIC_SHIELD: {
    ...
    elements: { Fire: 'Strong', Lightning: 'Weak' },
  },
  SUNSHINE_KING: {
    name: 'Sunshine King',
    LVL: 50,
    ...
    elements: { Fire: 'Strong', Wind: 'Strong', Resurrection: 'Weak' },
  },
  ...
  DEATH_BOAR: {
    ...
    elements: { Water: 'Weak', Fire: 'Weak', Lightning: 'Weak', Earth: 'Weak', Wind: 'Weak' },
  },
  DWARF: {
    name: 'Dwarf',
    LVL: 21,
    ...
    elements: { Fire: 'Strong', Wind: 'Weak' },
  },
  EAGLE_MAN: {
    name: 'Eagle Man',
    LVL: 22,
  ...
  HOLLY_BOY_2: {
    ...
    elements: { Water: 'Strong', Fire: 'Weak', Earth: 'Strong' },
  },
  HOLLY_SPIRIT: {
    name: 'Holly Spirit',
    LVL: 21,
    ...
    elements: { Water: 'Strong', Fire: 'Weak', Earth: 'Strong', Wind: 'Weak' },
  },
  KOBOLD_SWORD: {
    name: 'Kobold (sword)',
    LVL: 20,
    bits: 200,
    stats: { HP: 150, PWR: 150, SKL: 40, DEF: 42, SPD: 43, MGC: 20, LUK: 35 },
  ...
  ORC: {
    ...
    elements: { Fire: 'Weak', Lightning: 'Strong' },
  },
  SIMURGH: {
    name: 'Simurgh',
    LVL: 56,
  ...
  EKIDONNA: {
    ...
    elements: { Fire: 'Weak', Earth: 'Strong' },
  },
  ...
  DEMON_HOUND: {
    ...
    elements: { Water: 'Weak', Fire: 'Invulnerable', Earth: 'Weak' },
  },
  HAWK_MAN: {
    name: 'Hawk Man',
    LVL: 35,
  ...
  GRAVE_MASTER: {
    ...
    elements: { Fire: 'Strong', Lightning: 'Weak', Wind: 'Strong' },
  },
  ...
  GIANT_SNAIL: {
    ...
    elements: { Fire: 'Strong', Lightning: 'Weak', Wind: 'Weak' },
  },
  KILLER_SLIME: {
    name: 'Killer Slime',
    LVL: 7,
  ...
  KOBOLD_MAGE: {
    ...
    elements: { Water: 'Strong', Fire: 'Invulnerable', Lightning: 'Strong', Earth: 'Strong', Wind: 'Strong' },
  },
  ...
  DEVIL_ARMOR: {
    ...
    elements: { Fire: 'Strong', Lightning: 'Weak', Resurrection: 'Weak' },
  },
  DEVIL_SHIELD: {
    name: 'Devil Shield',
    LVL: 27,
  ...
  CREEPER: {
    ...
    LVL: 29,
    bits: 600,
    stats: { HP: 300, PWR: 210, SKL: 90, DEF: 35, SPD: 73, MGC: 40, LUK: 25 },
  ...
  DELF: {
    ...
    drops: [],
    elements: { Fire: 'Strong', Earth: 'Weak' },
  },
  RED_SLIME: {
    name: 'Red Slime',
    LVL: 27,
