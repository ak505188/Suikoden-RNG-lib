...
/** @typedef {Extract<Element, 'None'|'Fire'|'Water'|'Earth'|'Lightning'|'Wind'>} ElementalRuneElement */
export class Weapon {
  /**
  ...
  constructor(weapon, lvl = 1) {
    this.wpn = weapon;
    this.lvl = lvl;
    this.baseElement = weapon.ELEMENT || ELEMENTS.NONE;
    this.runePiece = {
      element: ELEMENTS.NONE,
      amount: 0
    }
  ...
  /** @param {ElementalRuneElement} element */
  ...
  get element() {
    return this.runePiece.element !== ELEMENTS.NONE ? this.runePiece.element : this.baseElement;
  }
