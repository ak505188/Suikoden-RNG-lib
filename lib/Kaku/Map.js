...
export default class Map {
  ...
  addBlacksmith() {
    ...
    this.setCellsRectangle(23, 25, 11, 11, TILE.DOOR);
  }

  addInn() {
    this.setCellsRectangle(46, 68, 6, 14, TILE.BUILDING);
    this.setCellsRectangle(53, 63, 14, 15, TILE.BUILDING);
    this.setCellsRectangle(57, 59, 15, 15, TILE.DOOR);
  }

  addArmorShop() {
    this.setCellsRectangle(17, 31, 19, 27, TILE.BUILDING);
    this.setCellsRectangle(23, 25, 27, 27, TILE.DOOR);
  }

  addItemShop() {
    this.setCellsRectangle(38, 50, 27, 35, TILE.BUILDING);
    this.setCellsRectangle(43, 45, 35, 35, TILE.DOOR);
  }

  addTavern() {
    this.setCellsRectangle(54, 64, 37, 45, TILE.BUILDING);
    this.setCellsRectangle(58, 60, 45, 45, TILE.DOOR);
  }

  addFlikHideout() {
    this.setCellsRectangle(8, 19, 33, 41, TILE.BUILDING);
    this.setCellsRectangle(11, 13, 41, 41, TILE.DOOR);
  }
  ...
  addBushes() {
    ...
    // Bush by Inn
    // Mina Ignores this Bush for collision, so I'm just getting rid of it.
    // addBush(67, 16);
    // this.setCellsRectangle(67, 69, 16, 16, TILE.BUSH);
